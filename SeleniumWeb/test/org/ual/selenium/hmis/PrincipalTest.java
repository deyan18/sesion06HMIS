...
public class PrincipalTest {
  ...
  public void paginaprincipal() {
    ...
    // 5 | assertText | css=.list-group-item:nth-child(2) | DocumentaciÃ³n GitHub: Pincha Aqui
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(2)")).getText(), is("Documentación GitHub: Pincha Aqui"));
    // 6 | assertText | css=.list-group-item:nth-child(3) | OrganizaciÃ³n HMIS: Pincha Aqui
    ...
    // 9 | assertText | css=.list-group-item:nth-child(6) | DocumentaciÃ³n Azure: Pincha Aqui
